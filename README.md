...
1) After downloading source code from GIT, Open web api project **RetrospectiveDataAPI** from Visual Studio 2019 with .net Core 3.1 framework and build and run the api project from visual studio.
